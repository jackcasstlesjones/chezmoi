...
alias setprimary="~/.config/scripts/set-primary-external.sh"
...
alias scan="scanimage -d 'escl:https://192.168.0.137:443' --format=png -o ~/scans/scan_\$(date +%Y%m%d_%H%M%S).png"
